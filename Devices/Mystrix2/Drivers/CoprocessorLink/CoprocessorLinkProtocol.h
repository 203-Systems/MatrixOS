...
#define COPROCESSOR_MAKE_CMD(direction, scope, id) ((uint8_t)((direction) | (scope) | ((id) & COPROCESSOR_CMD_ID_MASK)))
...
enum {
  ...
  COPROCESSOR_CMD_RESET_REQ = COPROCESSOR_MAKE_CMD(COPROCESSOR_CMD_DIR_REQUEST, COPROCESSOR_CMD_SCOPE_SYSTEM, COPROCESSOR_CMD_ID_RESET),
  COPROCESSOR_CMD_RESET_RSP = COPROCESSOR_MAKE_CMD(COPROCESSOR_CMD_DIR_RESPONSE, COPROCESSOR_CMD_SCOPE_SYSTEM, COPROCESSOR_CMD_ID_RESET),
  COPROCESSOR_CMD_ENTER_BOOTLOADER_REQ =
      COPROCESSOR_MAKE_CMD(COPROCESSOR_CMD_DIR_REQUEST, COPROCESSOR_CMD_SCOPE_SYSTEM, COPROCESSOR_CMD_ID_ENTER_BOOTLOADER),
  COPROCESSOR_CMD_ENTER_BOOTLOADER_RSP =
      COPROCESSOR_MAKE_CMD(COPROCESSOR_CMD_DIR_RESPONSE, COPROCESSOR_CMD_SCOPE_SYSTEM, COPROCESSOR_CMD_ID_ENTER_BOOTLOADER),
  ...
  COPROCESSOR_CMD_OTA_END_REQ = COPROCESSOR_MAKE_CMD(COPROCESSOR_CMD_DIR_REQUEST, COPROCESSOR_CMD_SCOPE_SYSTEM, COPROCESSOR_CMD_ID_OTA_END),
