...
private:
  ...
  MPEData* mpeLiveData = nullptr;
  MPEData* mpeSnapshotBuffers[2] = {nullptr, nullptr};
  const MPEData* publishedSnapshot = nullptr;
  uint8_t snapshotWriteIndex = 0U;
  CachedChangesState cachedChanges = {};
