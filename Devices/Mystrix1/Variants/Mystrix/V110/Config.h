...
inline void LoadV110() {
  ...
  LED::ledPin = V110::LED_PIN;

  KeyPad::fnPin = V110::FN_PIN;

  gpio_num_t _keypad_write_pins[X_SIZE] = {
      V110::KEY1_PIN, V110::KEY2_PIN, V110::KEY3_PIN, V110::KEY4_PIN, V110::KEY5_PIN, V110::KEY6_PIN, V110::KEY7_PIN, V110::KEY8_PIN,
  };
  ...
  HWMidi::txGpio = V110::POWER_CORD_PIN;

  Storage::sdClkPin = V110::SD_CLK_PIN;
  Storage::sdCmdPin = V110::SD_CMD_PIN;
  Storage::sdD0Pin = V110::SD_D0_PIN;
  Storage::sdD1Pin = V110::SD_D1_PIN;
  Storage::sdD2Pin = V110::SD_D2_PIN;
  Storage::sdD3Pin = V110::SD_D3_PIN;
  Storage::sdDetPin = V110::SD_DET_PIN;
  Storage::sd4BitMode = V110::SD_4BIT_MODE;
  Storage::sdFreqKhz = V110::SD_FREQ_KHZ;
}
} // namespace Device
