...
inline void LoadRevC() {
  ...
  LED::ledPin = REVC::LED_PIN;

  KeyPad::fnPin = REVC::FN_PIN;

  gpio_num_t _keypad_write_pins[X_SIZE] = {
      REVC::KEY1_PIN, REVC::KEY2_PIN, REVC::KEY3_PIN, REVC::KEY4_PIN, REVC::KEY5_PIN, REVC::KEY6_PIN, REVC::KEY7_PIN, REVC::KEY8_PIN,
  };
  ...
  HWMidi::txGpio = REVC::POWER_CORD_PIN;

  Storage::sdClkPin = REVC::SD_CLK_PIN;
  Storage::sdCmdPin = REVC::SD_CMD_PIN;
  Storage::sdD0Pin = REVC::SD_D0_PIN;
  Storage::sdD1Pin = REVC::SD_D1_PIN;
  Storage::sdD2Pin = REVC::SD_D2_PIN;
  Storage::sdD3Pin = REVC::SD_D3_PIN;
  Storage::sdDetPin = REVC::SD_DET_PIN;
  Storage::sd4BitMode = REVC::SD_4BIT_MODE;
  Storage::sdFreqKhz = REVC::SD_FREQ_KHZ;
}
} // namespace Device
