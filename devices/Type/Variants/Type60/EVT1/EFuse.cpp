...
void BurnEFuse() {
  ...
  MLOGD("BurnEFuse", "Burning Device Info - Status: %s", esp_err_to_name(status));
  ...
  MLOGD("BurnEFuse", "Burning EFUSE_WR_DIS_GROUP_1 - Status: %s", esp_err_to_name(status));
  ...
  MLOGD("BurnEFuse", "Burning EFUSE_WR_DIS_GROUP_2 - Status: %s", esp_err_to_name(status));
  ...
  MLOGD("BurnEFuse", "Burning EFUSE_WR_DIS_GROUP_3 - Status: %s", esp_err_to_name(status));
  ...
  // Write protection for Device Info
  status = esp_efuse_set_write_protect(EFUSE_BLK3);
  MLOGD("BurnEFuse", "Block 3 (Device Info) write protected - Status: %s",
                              esp_err_to_name(status));
