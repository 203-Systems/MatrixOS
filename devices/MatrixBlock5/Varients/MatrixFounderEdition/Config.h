...
inline GPIO keypad_write_pins[] = {
    ...
    GPIO(Key2_GPIO_Port, Key2_Pin),
    GPIO(Key3_GPIO_Port, Key3_Pin),
    GPIO(Key4_GPIO_Port, Key4_Pin),
    GPIO(Key5_GPIO_Port, Key5_Pin),
    GPIO(Key6_GPIO_Port, Key6_Pin),
    GPIO(Key7_GPIO_Port, Key7_Pin),
    GPIO(Key8_GPIO_Port, Key8_Pin),
};

inline GPIO keypad_read_pins[] = {
    GPIO(KeyRead1_GPIO_Port, KeyRead1_Pin),
    GPIO(KeyRead2_GPIO_Port, KeyRead2_Pin),
    GPIO(KeyRead3_GPIO_Port, KeyRead3_Pin),
    GPIO(KeyRead4_GPIO_Port, KeyRead4_Pin),
    GPIO(KeyRead5_GPIO_Port, KeyRead5_Pin),
    GPIO(KeyRead6_GPIO_Port, KeyRead6_Pin),
    GPIO(KeyRead7_GPIO_Port, KeyRead7_Pin),
    GPIO(KeyRead8_GPIO_Port, KeyRead8_Pin),
};
