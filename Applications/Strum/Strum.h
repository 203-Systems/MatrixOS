...
public:
  ...
  StrumBarConfig strumBarConfigs[2] = {{Color(0x00FFFF), EChord::MAJOR_TRIAD, 0, 3, 0, 200},
                                       {Color(0xFF00FF), EChord::MAJOR_TRIAD, 0, 3, 0, 200}};

  //   EChord major_chords[7] = {
  //     EChord::MAJOR_TRIAD, EChord::MAJOR_SIXTH, EChord::MAJOR_SIXTH_NINTH, EChord::MAJOR_SEVENTH, EChord::MAJOR_NINTH,
  //     EChord::MAJOR_ELEVENTH, EChord::MAJOR_THIRTEENTH};
  //   string major_chord_names[7] = {"Major", "Major 6th", "Major 6/9", "Major 7th", "Major 9th", "Major 11th", "Major 13th"};

  //   EChord minor_chords[7] = {EChord::MINOR_TRIAD, EChord::MINOR_SIXTH, EChord::MINOR_SEVENTH, EChord::MINOR_SEVENTH_FLAT_FIVE,
  //   EChord::MINOR_NINTH, EChord::MINOR_ELEVENTH, EChord::MINOR_THIRTEENTH};
  //     string minor_chord_names[7] = {"Minor", "Minor 6th", "Minor 7th", "Minor 7th b5", "Minor 9th", "Minor 11th", "Minor 13th"};

  //   EChord dominant_chords[4] = {EChord::DOMINANT_SEVENTH, EChord::DOMINANT_NINTH, EChord::DOMINANT_ELEVENTH,
  //   EChord::DOMINANT_THIRTEENTH}; string dominant_chord_names[4] = {"Dominant 7th", "Dominant 9th", "Dominant 11th", "Dominant 13th"};
  ...
  //   EChord altered_chords[4] = {EChord::DOMINANT_SEVENTH_SHARP_NINE, EChord::DOMINANT_SEVENTH_FLAT_NINE,
  //   EChord::DOMINANT_SEVENTH_SHARP_FIVE, EChord::DOMINANT_SEVENTH_FLAT_FIVE}; string altered_chord_names[4] = {"Dominant 7th #9",
