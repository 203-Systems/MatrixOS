...
#ifndef ___MatrixOSPoint_Point__H
#define ___MatrixOSPoint_Point__H
#include <stdio.h>
#include <stdlib.h>
#include "PikaObj.h"
...
PikaObj* _MatrixOSPoint_Point_Rotate(PikaObj *self, PikaObj* rotation, PikaObj* dimension, pika_bool reverse);
