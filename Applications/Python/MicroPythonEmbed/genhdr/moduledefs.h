...
extern const struct _mp_obj_module_t matrixos_module;
#undef MODULE_DEF_MATRIXOS
#define MODULE_DEF_MATRIXOS { MP_ROM_QSTR(MP_QSTR_MatrixOS), MP_ROM_PTR(&matrixos_module) },
