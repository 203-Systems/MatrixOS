...
public:
  ...
  Color colorPresets[6][2] = {{0x0040FF, 0x00FFFF}, {0x8000FF, 0xFF00FF}, {0xFF4000, 0xFFFF00},
                              {0xFF0080, 0xFF60C0}, {0x00FF00, 0x80FF00}, {0x40FFFF, 0xFFFFFF}};

  static inline uint16_t scales[16] = {MINOR,          MAJOR,        DORIAN,     PHRYGIAN,         MIXOLYDIAN,      MELODIC_MINOR_ASCENDING,
                                       HARMONIC_MINOR, BEBOP_DORIAN, BLUES,      MINOR_PENTATONIC, HUNGARIAN_MINOR, UKRAINIAN_DORIAN,
                                       MARVA,          TODI,         WHOLE_TONE, CHROMATIC};

  static inline const string scale_names[16] = {
