...
Color MatrixBoot::BootPhase2Color(int16_t time, uint8_t hue)
{
    ...
    {
        case 0:
            color.R = brightness; color.G = t; color.B = p;
            break;
        case 1:
            color.R = q; color.G = brightness; color.B = p;
            break;
        case 2:
            color.R = p; color.G = brightness; color.B = t;
            break;
        case 3:
            color.R = p; color.G = q; color.B = brightness;
            break;
        case 4:
            color.R = t; color.G = p; color.B = brightness;
            break;
        default:
            color.R = brightness; color.G = p; color.B = q;
            break;
    }
