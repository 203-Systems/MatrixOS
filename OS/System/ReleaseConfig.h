...
#define MATRIXOS_VERSION_ID_TEMPLATE                                                                                                       \
  (((MATRIXOS_MAJOR_VER & 0xFF) << 24) | ((MATRIXOS_MINOR_VER & 0x7F) << 16) | ((MATRIXOS_PATCH_VER & 0xFF) << 8))
...
#define MATRIXOS_LOG_LEVEL LOG_LEVEL_INFO
const string MATRIXOS_VERSION_STRING =
    XSTR(MATRIXOS_MAJOR_VER) "." XSTR(MATRIXOS_MINOR_VER) MATRIXOS_MINOR_VERSION_STRING " RC" XSTR(MATRIXOS_RELEASE_VER);
...
#define MATRIXOS_LOG_LEVEL LOG_LEVEL_INFO
const string MATRIXOS_VERSION_STRING =
    XSTR(MATRIXOS_MAJOR_VER) "." XSTR(MATRIXOS_MINOR_VER) MATRIXOS_MINOR_VERSION_STRING " Beta " XSTR(MATRIXOS_RELEASE_VER);
...
#define MATRIXOS_LOG_LEVEL LOG_LEVEL_INFO
const string MATRIXOS_VERSION_STRING =
    XSTR(MATRIXOS_MAJOR_VER) "." XSTR(MATRIXOS_MINOR_VER) MATRIXOS_MINOR_VERSION_STRING " Nighty " __DATE__;
...
const string MATRIXOS_VERSION_STRING =
    XSTR(MATRIXOS_MAJOR_VER) "." XSTR(MATRIXOS_MINOR_VER) MATRIXOS_MINOR_VERSION_STRING " InDev " __DATE__ " " __TIME__;
