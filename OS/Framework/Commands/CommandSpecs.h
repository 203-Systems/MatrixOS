...
// Specific commands from each protocol depends on the protocol itself. Each will be slightly different, as midi only has 7bits. HID packet
// size is fixed. But command ID should be consistent across all protocols. Each protocol can also opt out of implementing some of the
// commands.

// System Command Byte Format
#define MATRIXOS_COMMAND_GET_OS_VERSION                                                                                                    \
  0x00 // Returns [MATRIXOS_COMMAND_GET_VERSION, MATRIXOS_MINOR_VER, MATRIXOS_MAJOR_VER, MATRIXOS_PATCH_VER, MATRIXOS_BUILD_VER]
#define MATRIXOS_COMMAND_GET_DEVICE_NAME                                                                                                   \
  0x01 // Returns [MATRIXOS_COMMAND_GET_DEVICE_ID, Device::device_name] device name as null terminated array
#define MATRIXOS_COMMAND_GET_DEVICE_MODEL_ID                                                                                               \
  0x02 // Returns [MATRIXOS_COMMAND_GET_DEVICE_MODEL_ID, Device::model_id] model id as null terminated array
#define MATRIXOS_COMMAND_GET_DEVICE_SERIAL                                                                                                 \
  0x03 // Returns [MATRIXOS_COMMAND_GET_DEVICE_SERIAL, Device::serial_number] serial number as null terminated array
#define MATRIXOS_COMMAND_GET_DEVICE_ID                                                                                                     \
  0x04 // Returns [MATRIXOS_COMMAND_GET_DEVICE_ID, Device::device_id] device id as null terminated array
#define MATRIXOS_COMMAND_GET_DEVICE_SIZE                                                                                                   \
  0x05 // Returns [MATRIXOS_COMMAND_GET_DEVICE_SIZE, Device::x_size, Device::y_size] device size as null terminated array
#define MATRIXOS_COMMAND_GET_DEVICE_LED_COUNT                                                                                              \
  0x06 // Returns [MATRIXOS_COMMAND_GET_DEVICE_LED_COUNT, Device::LED::count] led count as null terminated array
...
#define MATRIXOS_COMMAND_LED_SET_COLOR_XY                                                                                                  \
  0x50 // [MATRIXOS_COMMAND_LED_SET_COLOR_XY, x, y, color, layer as optional] Sets the color of the LED at x, y
#define MATRIXOS_COMMAND_LED_SET_COLOR_ID                                                                                                  \
  0x51                                 // [MATRIXOS_COMMAND_LED_SET_COLOR_ID, id, color, layer as optional] Sets the color of the LED at id
...
#define MATRIXOS_COMMAND_LED_FILL_PARTITION                                                                                                \
