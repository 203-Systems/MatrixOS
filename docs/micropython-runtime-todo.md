...
| `NVS` | Typed `u8/u16/u32`, size, delete, bytes, string helpers, and string-key hashing are implemented and covered by API smoke. | Finalize naming and error behavior in `docs/micropython-api.md`. |
