...
class Strum : public Application {
 public:
  ...
  CreateSavedVar("Strum", chord, EChord, EChord::MAJOR_TRIAD);
  CreateSavedVar("Strum", root, uint8_t, 0);
  CreateSavedVar("Strum", octave, uint8_t, 2);
  CreateSavedVar("Strum", midi_channel, uint8_t, 0);
