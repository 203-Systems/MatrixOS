...
class UITwoToneSelector : public UIComponent
{
    ...
    UITwoToneSelector(Dimension dimension, uint16_t count, Color color1, Color color2, uint8_t* value, uint8_t threshold, uint8_t* map, std::function<void(uint8_t)> callback)
    {
