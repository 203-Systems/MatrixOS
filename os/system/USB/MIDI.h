...
namespace MatrixOS::USB
{
  class MIDI : public UsbInterface
  {
   ...
   public:
    MIDI(string interface_name = "", uint16_t ep_size = 64); // Use "" as interface name will use default string generated by the OS
    MIDI(uint8_t cable_nums, string interface_name = "", uint16_t ep_size = 64); // Use "" as interface name will use default string generated by the OS
    ~MIDI();
